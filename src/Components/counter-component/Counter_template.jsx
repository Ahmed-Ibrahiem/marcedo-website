  ...
  return (
    <div ref={counter_ref} className={style.couter_template}>
      {counter_data.map((data, index) => {
        ...
        return <Section key={index} data={data} ref={counter_ref} />;
      })}
    </div>
  );
};
